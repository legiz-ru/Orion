...
if [ "$LANG" = "ru" ]; then
    ...
    Q_APPSCONFIG="Хотите использовать свой список приложений? (Формат списка Remnawave 2.4.0+)"
    ...
    Q_APPSCONFIG="Do you want to use your list of applications? (App list format Remnawave 2.4.0+)"
